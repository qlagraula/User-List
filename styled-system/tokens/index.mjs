const tokens = {
  ...
  "colors.borders.secondary": {
    "value": "#EF8559",
    "variable": "var(--colors-borders-secondary)"
  },
  "colors.surface.primary": {
    "value": "#FFFFFF",
    "variable": "var(--colors-surface-primary)"
  },
  "colors.surface.secondary": {
    "value": "#FAFAFB",
    "variable": "var(--colors-surface-secondary)"
  },
  "colors.text.primary": {
    "value": "#24292F",
  ...
  "colors.text.third": {
    "value": "#B2B7C2",
    "variable": "var(--colors-text-third)"
  },
  "sizes.0": {
    "value": "0rem",
  ...
  "sizes.topBar": {
    "value": "60px",
    "variable": "var(--sizes-top-bar)"
  },
  "sizes.paginationItem": {
    "value": "32px",
    "variable": "var(--sizes-pagination-item)"
  },
  "sizes.tableRow": {
    "value": "60px",
    "variable": "var(--sizes-table-row)"
  },
  "sizes.tableHeader": {
    "value": "40px",
  ...
  "colors.colorPalette.third": {
    "value": "var(--colors-color-palette-third)",
    "variable": "var(--colors-color-palette-third)"
  }
}
